...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Симпатия") action ShowMenu("affection_screen")
...
## Экран статистики #########################################################
##
## Используется, чтобы показать статистику персонажа и его взаимоотношений

screen affection_screen():
    tag menu
    window:
        style "default"
    text "Метрики симпатии" size 50 yalign 0.1
    vbox:
        yalign 0.3
        xalign 0.5
        spacing 15

        text "Эйлин: [affection_eileen]%" size 25
        text "Мария: [affection_maria]%" size 25
        text "София: [affection_sophia]%" size 25
        text "Алиса: [affection_alice]%" size 25
        text "Кира: [affection_kira]%" size 25

    textbutton "Назад" action Return() yalign 0.9 xalign 0.5
